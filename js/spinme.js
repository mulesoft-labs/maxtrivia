function spinme(options, drawWheel)
{
    defaultOptions = {
        ...
        'textMargin'        : 75,         // Margin between the inner or outer of the wheel (depends on textAlignment).
...
// ====================================================================================================================
spinme.prototype.updateSegmentSizes = function()
{
...
// ====================================================================================================================
spinme.prototype.clearCanvas = function()
{
    if (this.ctx)
    {
...
// ====================================================================================================================
spinme.prototype.draw = function(clearTheCanvas)
{
...
// ====================================================================================================================
spinme.prototype.drawPointerGuide = function()
{
...
// ====================================================================================================================
spinme.prototype.drawWheelImage = function()
{
...
// ====================================================================================================================
spinme.prototype.drawSegmentImages = function()
{
...
// ====================================================================================================================
spinme.prototype.drawSegments = function()
{
    // Again check have context in case this function was called directly and not via draw function.
    if (this.ctx)
    {
...
// ====================================================================================================================
spinme.prototype.drawSegmentText = function()
{
...
// ====================================================================================================================
spinme.prototype.degToRad = function(d)
{
...
// ====================================================================================================================
spinme.prototype.setCenter = function(x, y)
{
    this.centerX = x;
    this.centerY = y;
}
...
// ====================================================================================================================
spinme.prototype.addSegment = function(options, position)
{
...
// ====================================================================================================================
spinme.prototype.setCanvasId = function(canvasId)
{
    if (canvasId)
    {
...
// ====================================================================================================================
spinme.prototype.deleteSegment = function(position)
{
...
// ====================================================================================================================
spinme.prototype.windowToCanvas = function(x, y)
{
...
// ====================================================================================================================
spinme.prototype.getSegmentAt = function(x, y)
{
...
// ====================================================================================================================
spinme.prototype.getSegmentNumberAt = function(x, y)
{
...
// ====================================================================================================================
spinme.prototype.getIndicatedSegment = function()
{
...
// ====================================================================================================================
spinme.prototype.getIndicatedSegmentNumber = function()
{
...
// ==================================================================================================================================================
spinme.prototype.getRotationPosition = function()
{
...
// ==================================================================================================================================================
spinme.prototype.startAnimation = function()
{
    if (this.animation)
    {
...
// ==================================================================================================================================================
spinme.prototype.stopAnimation = function(canCallback)
{
...
// ==================================================================================================================================================
spinme.prototype.pauseAnimation = function()
{
    if (this.tween)
    {
        this.tween.pause();
...
// ==================================================================================================================================================
spinme.prototype.resumeAnimation = function()
{
    if (this.tween)
    {
        this.tween.play();
...
// ====================================================================================================================
spinme.prototype.computeAnimation = function()
{
    if (this.animation)
    {
...
// ====================================================================================================================
spinme.prototype.getRandomForSegment = function(segmentNumber)
{
    var stopAngle = 0;
